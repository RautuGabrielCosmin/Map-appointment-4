...
public class Appointment implements Identifiable<Integer>,Serializable
{
    ...
    public boolean equals(Object otherObject) {
        ...
        return id == that.id && Objects.equals(patientName, that.patientName)
                && Objects.equals(doctorName, that.doctorName) && Objects.equals(hour, that.hour) && Objects.equals(date, that.date);
    }
