...
public class ServiceDentistAssignments {
    ...
    //highly depends on the dentist
    public void add(int id, Appointment appointment, Dentist dentist, float consultationCost)  {
        try{
    ...
    public void modify(int id_whereToModify, Appointment appointment,Dentist dentist,float consultationCost){
        ...
        try{
            DentistAssignment dentistAssignment
                    =new DentistAssignment(id_whereToModify,appointment,dentist,consultationCost);
    ...
    public Iterable<DentistAssignment> getAll() throws ExceptionRepository{
