...
public class UserInterface {
    ...
    static final int GET_NAME_DOCTOR_MOST_APPOINTMENTS_OPTION = 7;
    ...
    public static String menuAppointments() {
        return "\nMENU APPOINTMENTS\n" +
                ...
                "\n" + GET_NAME_DOCTOR_MOST_APPOINTMENTS_OPTION + ".Get the name of the doctor with the most appointments" +
            ...
            while (!exit) {
                ...
                switch (option) {
                    ...
                    case GET_IDS_OF_APPOINTMENTS_OF_DOCTOR_OPTION:
                        System.out.println("Doctor name:");
                        String doctorName_ids_of_appointments_of_doctor = readString();

                        System.out.println(serviceAppointments.getIdsOfAppointmentsOfDoctor(doctorName_ids_of_appointments_of_doctor));
                        break;
                    case GET_NAME_DOCTOR_MOST_APPOINTMENTS_OPTION:
